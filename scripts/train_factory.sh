...
CUDA_VISIBLE_DEVICES=0 python scripts/reinforcement_learning/rl_games/train.py \
    ...
    --track --wandb-project-name FactoryXarm --wandb-name ${time}_gearmesh_dmr_controller_noise_obj_obs --wandb-entity ss7050-columbia \
    agent.params.config.full_experiment_name=${time}_gearmesh_dmr_controller_noise_obj_obs --headless