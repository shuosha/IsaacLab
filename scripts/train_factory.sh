...
#     --track --wandb-project-name FactoryXarm --wandb-name ${time}_peginsert_no_grip_active_grasp --wandb-entity ss7050-columbia \
#     agent.params.config.full_experiment_name=${time}_peginsert_no_grip_active_grasp --headless
...
#     --track --wandb-project-name FactoryXarm --wandb-name ${time}_nutthread_no_grip_active_grasp --wandb-entity ss7050-columbia \
#     agent.params.config.full_experiment_name=${time}_nutthread_no_grip_active_grasp --headless