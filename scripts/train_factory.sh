...
#     --track --wandb-project-name FactoryXarm --wandb-name ${time}_gearmesh_dmr5_no_grip --wandb-entity ss7050-columbia \
#     agent.params.config.full_experiment_name=${time}_gearmesh_dmr5_no_grip --headless
